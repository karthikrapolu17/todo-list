...
1. **Clone the Repository:**
   ...
   ```bash
   git clone git@github.com/karthikrapolu17/todo-list.git
   ```
...
The TO-DOIT App is deployed and accessible online. You can use the following link to access the application
...
This project is licensed under the [MIT License](https://opensource.org/licenses/MIT) and was originally developed by [@karthik rapolu](https:https://github.com/karthikrapolu17). 
